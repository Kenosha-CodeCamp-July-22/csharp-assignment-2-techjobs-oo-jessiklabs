...
namespace TechJobsOOTests
{
    ...
    public class TestTask5
    {
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            string text = System.IO.File.ReadAllText("C:\\Users\\jojac\\Documents\\htmlcss\\LaunchCode\\csharp\\Assignment2\\TechJobsOOTests\\StartsAndEndsWithNewLine.txt").ToString();
        ...
        public void Test_TestToStringHandlesEmptyField()
        {
                        //setup
            //comparing output to a text file.  id numbers may get a little wonky
            string text = System.IO.File.ReadAllText("C:\\Users\\jojac\\Documents\\htmlcss\\LaunchCode\\csharp\\Assignment2\\TechJobsOOTests\\EmptyFieldTest.txt").ToString();
